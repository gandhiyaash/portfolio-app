...
export const Nav = () => {
    ...
    return (
        ...
        >
            ...
            <Link href="/about#contact" className="bg-gradient-to-r from-[#F7931A] to-[#FFB874] text-[#4b2800] font-mono font-bold px-6 py-2 uppercase text-xs tracking-tighter active:scale-95 transition-all duration-150 hover:shadow-[0_0_15px_rgba(34,197,94,0.4)]">
                Start a Project
            </Link>
        </motion.nav>
    );
